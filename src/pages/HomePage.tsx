          ...
          <div className="relative max-w-7xl mx-auto px-4">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4">
                <span className="text-text-primary">{currentLanguage === 'zh' ? '格式转换' : 'Format'}</span>
                <span className="gradient-text"> {currentLanguage === 'zh' ? '中转站' : 'Hub'}</span>
              </h1>
              <p className="text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto">
                {currentLanguage === 'zh'
                  ? '聚合热门格式转换工具，快速找到并访问目标网站'
                  : 'Aggregate popular format conversion tools, find and visit target websites quickly'}
              </p>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm text-text-muted">
                  {currentLanguage === 'zh' ? '转换工具' : 'Conversion Tools'}
                </div>
              </div>
              <div className="text-center">
